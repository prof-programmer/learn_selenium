...
import time
from auth_data import mail_password, mail_login
import pickle # cookie faylni saqlash uchun pickle moduli kerak boladi
...
try:
    ...
    # email_input.send_keys(mail_login)
    # time.sleep(3)
    ...
    for cookie in pickle.load(open(f'{mail_login}_cookies', 'rb')):
